...
# Local/system stacks only. Neither the server nor the browser needs a font CDN to
# render the first view, so a cold/offline worker preserves the complete UI.
