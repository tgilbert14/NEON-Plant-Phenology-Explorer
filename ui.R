      ...
      nav_panel(title = tagList(bs_icon("bullseye"), " Onset Lab"), value = "onset",
        ...
        card(full_screen = TRUE,
          card_head("bullseye", "Green-up onset × leaf-active days, by plant",
            info_pop("Reading this", p("Left = early risers (wake early in spring); right = late sleepers. High = many leaf-active days; low = brief. The ", tags$span(style="color:#c9a300;font-weight:700","gold diamond"), " is the plant you're viewing."))),
